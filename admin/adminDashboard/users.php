...
if (isset($_GET['delete'])) {
  ...
  $delete_query = mysqli_query($con, "DELETE FROM `user` WHERE uid=$delete_id") or die('query failed');
  if ($delete_query) {
...
<div id="confirm-modal" style="display: none;">
  ...
  <aside id="sidebar">
        ...
        <ul class="sidebar-list">
          ...
          <li class="sidebar-list-item">
           ...
           <div >
           <div class="title" style="font-size:30px;"> Users</div>
                <table >
                    <thead>
                    ...
                    <?php $query=mysqli_query($con,"SELECT user.* FROM `user` ");
                        ...
                        <tr>
                            <td><img class="w-100" src="http://localhost/rjHousing/admin/user/<?php echo $row['uimage'];?>"> </td>
                            <td><?php echo $row['uname'];?></td>
                            <td style="white-space: nowrap;"><?php echo $row['uemail'];?></td>
                            <td style="white-space: nowrap;"><?php echo $row['uphone'];?></td>
                            
                            <td style="white-space: nowrap;"><?php echo $row['uid']; ?></td>
                            <td><button type="button" onclick="deleteDetails(<?php echo $row['uid']; ?>)"> Delete</button> </td>                            
                        </tr>
                        <?php } ?>
            </tbody>
            </table>
  ...
  confirmYes.onclick = function() {
    ...
    xmlhttp.open("GET", "user.php?delete=" + uid, true);
    xmlhttp.send();
